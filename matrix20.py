...
STATS_DISPLAY_DURATION = 2 # default: 5.0
...
def command_processor(command_string):
    """
    The central hub for processing all user commands.
    """
    global fade_out_active, fade_out_timer, stats_display_timer
    ...
    if command == "calc":
        ...
        # We will launch the notepad from the main loop after the fade
...
def draw_seamless_rain_to_buffer(messages_data, color_pair):
    ...
    if fade_out_active and current_time < fade_out_timer:
        ...
        # Reduce the number of new streaks created based on remaining time
...
def main(stdscr):
    ...
    while True:
        ...
        # Once the fade out is complete, exit the application
