...
def main(stdscr):
    global streaks, screen_height, screen_width, current_buffer, last_buffer, input_buffer, OUTPUT_MESSAGE, OUTPUT_FORMAT, stats_display_timer, fade_out_active, fade_out_timer, NOTEPAD_FILENAME_TO_OPEN, SHOULD_EXIT, typing_test_active
